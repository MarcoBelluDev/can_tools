...
use crate::{MessageDB, SignalDB, NodeDB, IdFormat};
use crate::types::message_db::normalize_id_hex;
...
impl Database {
    ...
    pub(crate) fn add_message_if_absent(
        ...
        let id_format: IdFormat = if id > 2048 {IdFormat::Extended} else {IdFormat::Standard};
