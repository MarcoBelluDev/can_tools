...
pub(crate) fn decode(db: &mut DatabaseDBC, line: &str) {
    ...
    if let Some(default_value) = parsed_default {
        ...
        match spec.type_of_object {
            ...
            crate::dbc::types::attributes::AttrObject::Database => {}
            crate::dbc::types::attributes::AttrObject::Node => {
                db.for_each_node_mut(|node| {
                    node.attributes
                        .insert(name.to_string(), default_value.clone());
                });
            }
            crate::dbc::types::attributes::AttrObject::Message => {
            ...
            crate::dbc::types::attributes::AttrObject::Signal => {
